<script lang="ts">
  ...
  const COUNTRY_GROUPS: CountryGroup[] = [
    ...
    },
    {
      ...
      members: [
        ...
        'South Africa', 'South Korea', 'T\u00FCrkiye', 'United Kingdom', 'United States',
      ],
    },
    {
      id: 'eu',
    ...
    },
    {
      ...
      aliases: ['opec'],
      members: [
        'Algeria', 'Angola', 'Congo', 'Gabon', 'Iran', 'Iraq', 'Kuwait',
    ...
    },
    {
      ...
      members: [
        ...
        'Oman', 'Qatar', 'Saudi Arabia', 'Syria', 'T\u00FCrkiye',
  ...
  const matchedGroups = $derived.by(() => {
    ...
    return COUNTRY_GROUPS.filter((g) =>
