...
function normalizeGraphNodes(nodes: Array<Record<string, unknown>>): GraphNode[] {
  return nodes.map((n) => ({
    ...
    full_name: (n.full_name || n.name) as string | undefined,
    ...
    headquarters_subdivision: n.headquarters_subdivision as string | undefined,
    registration_country: n.registration_country as string | undefined,
    registration_subdivision: n.registration_subdivision as string | undefined,
    entity_type: n.entity_type as string | undefined,
    legal_entity_type: n.legal_entity_type as string | undefined,
