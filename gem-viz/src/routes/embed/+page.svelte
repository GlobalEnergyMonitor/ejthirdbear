<script lang="ts">
  ...
  const widgets: WidgetSpec[] = [
    { slug: 'entity', name: 'Entity Card', description: 'Company profile with ownership flower and asset list', dataSrc: '/embed/entity?id=E100000000650', height: 600 },
    { slug: 'asset', name: 'Asset Card', description: 'Asset profile with owners and metadata', dataSrc: '/embed/asset?id=G100000109409', height: 500 },
    { slug: 'ownership-flower', name: 'Ownership Flower', description: 'Radial ownership diagram for an entity', dataSrc: '/embed/ownership-flower?ownerId=E100000000650', height: 500 },
    { slug: 'ownership-graph', name: 'Control Chain', description: 'Interactive ownership tree (upstream or downstream)', dataSrc: '/embed/ownership-graph?entityId=E100000000650&direction=down', height: 600 },
    { slug: 'controlchain', name: 'Control Chain Search', description: 'Full search + ownership tree flow', dataSrc: '/embed/controlchain', height: 700 },
    { slug: 'coal-plant', name: 'Coal Plant Card', description: 'Rich 6-tab coal plant detail card', dataSrc: '/embed/coal-plant?id=L100000104107', height: 600 },
    { slug: 'project-card', name: 'Project Card', description: 'Tabbed asset detail card (any tracker)', dataSrc: '/embed/project-card?id=G100000109409', height: 500 },
    { slug: 'asset-ring', name: 'Asset Ring', description: 'Circular asset distribution visualization', dataSrc: '/embed/asset-ring?entityId=E100000000650', height: 500 },
    { slug: 'ultimate-owners', name: 'Ultimate Owners', description: 'Ultimate beneficial owners at top of chain', dataSrc: '/embed/ultimate-owners?entityId=E100000000650', height: 400 },
    { slug: 'network-3d', name: '3D Network Graph', description: 'Force-directed ownership network', dataSrc: '/embed/network-3d?entityId=E100000000650', height: 500 },
    { slug: 'asset-search', name: 'Asset Search', description: 'Search bar for assets', dataSrc: '/embed/asset-search', height: 300 },
  ...
  function copyCode(w: WidgetSpec) {
    ...
    copiedSlug = w.slug;
    setTimeout(() => { if (copiedSlug === w.slug) copiedSlug = null; }, 2000);
  }
</script>
